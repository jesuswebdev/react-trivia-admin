      ...
      <Fragment>
        ...
        <div className="level">
          <div className="level-item has-text-centered">
            <Link to="/questions/new" className="button is-info">
              Crear Pregunta
            </Link>
          </div>
          {(this.props.questionsStats || {}).questions_waiting_approval > 0 && (
            <div className="level-item has-text-centered">
              <Link to="/suggestions" className="button is-info">
                Ver sugerencias
              </Link>
            </div>
          )}
        ...
        {this.props.loadingFirstPage ? (
          ...
          <Fragment>
            ...
            <div
              ...
              style={{ marginTop: '1px', minHeight: '85vh' }}>
              {this.props.loadingNextPage && (
                <p
                  className="has-text-centered"
                  style={{ marginTop: '25px', minHeight: '100vh' }}>
                  Cargando preguntas...
                </p>
              )}
              {this.props.currentPage &&
                !this.props.loadingNextPage &&
                this.props.currentPage.questions.map(question => {
                  let tagClass;
